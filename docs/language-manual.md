...
!!! note "Qualified types"
    ...
    the compiler needs to add a hidden parameter to the enclosing function which passes the instance of the trait in question (in this case `Numeric`). 

    In this case, the final code generated by the compiler will look something like this:
    ...
    This is how literals like `42` can be polymorphic.
